namespace PortalExec.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5001/";
    public readonly static string iOSAppName = "com.aspad.PortalExec";
    public readonly static string AndroidAppName = "com.aspad.PortalExec";
